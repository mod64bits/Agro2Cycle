    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=100, verbose_name='Tipo de Usuário')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_technician', models.BooleanField(default=False, verbose_name='Técnico')),
                ('user_type', models.CharField(choices=[('seller', 'Vendedor'), ('buyer', 'Comprador')], max_length=10, verbose_name='Tipo de Usuário')),
